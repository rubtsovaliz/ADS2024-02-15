...
// Реализация красно-черного дерева в виде отсортированного словаря
...
public class MyRbMap implements SortedMap<Integer, String> {
    ...
    // Метод для корректировки узла после добавления
    ...
    // Метод для возврата подмножества от начального ключа до указанного ключа
    @Override
    ...
    // Рекурсивный метод для формирования подмножества от указанного узла до конечного ключа
    ...
    // Метод для возврата подмножества от указанного ключа до конечного ключа
    @Override
    ...
    // Рекурсивный метод для формирования подмножества от начального узла до указанного ключа
    ...
    // Метод для возврата первого ключа в отсортированном порядке
    @Override
    ...
    // Метод для возврата последнего ключа в отсортированном порядке
    @Override
    ...
    // Метод для возврата размера словаря
    @Override
    public int size() {
        return size;
    }

    // Метод для проверки, пустой ли словарь
    @Override
    ...
    // Метод для формирования строки из элементов словаря
    ...
    // Переопределенный метод toString для вывода словаря в виде строки
    @Override
